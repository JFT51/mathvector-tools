	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'appear-delay-1': 'appear 0.5s cubic-bezier(0.16, 1, 0.3, 1) 0.1s forwards',
				'appear-delay-2': 'appear 0.5s cubic-bezier(0.16, 1, 0.3, 1) 0.2s forwards',
				'appear-delay-3': 'appear 0.5s cubic-bezier(0.16, 1, 0.3, 1) 0.3s forwards',
				'vector-draw': 'vector-draw 1.5s ease forwards',
